            ...
            <div class="flex flex-1 flex-col h-full min-h-0 bg-surface rounded-3xl shadow-sm relative overflow-hidden">
                ...
                <div class="px-stack-sm sm:px-stack-md py-stack-sm bg-surface/90 backdrop-blur-sm z-10 flex items-center justify-between shrink-0 border-b border-outline-variant/10">
                    <div class="flex items-center gap-2 sm:gap-3">
                        ...
                        <div>
                            <h2 class="text-lg font-headline-md text-on-surface">{{ $conversation->title ?: 'Sesión Actual' }}</h2>
                ...
                <div class="flex-1 min-h-0 overflow-y-auto p-stack-md flex flex-col gap-stack-md scroll-smooth no-scrollbar" data-chat-messages>
                    <div class="flex justify-center my-stack-sm">
                        <span class="text-label-sm font-label-sm text-outline px-3 py-1 bg-surface-container-lowest rounded-full shadow-sm">Hoy</span>
                    </div>
                ...
                <div class="p-stack-md bg-surface-container-lowest shrink-0">
                    <div class="flex gap-2 overflow-x-auto pb-stack-sm no-scrollbar mb-2">
                    ...
                    <div class="relative bg-surface rounded-[24px] shadow-sm flex items-end min-h-[64px] p-2 ring-1 ring-outline-variant/30 focus-within:ring-2 focus-within:ring-primary focus-within:shadow-md transition-all">
                        <label class="sr-only" for="chat-input">Escribe tu mensaje</label>
                        <textarea
                            class="flex-1 bg-transparent border-none outline-none resize-none max-h-[150px] min-h-[48px] py-3 px-4 text-body-md font-body-md text-on-surface placeholder:text-outline focus:ring-0"
                            id="chat-input"
